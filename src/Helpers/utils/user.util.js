...
export const getCompanyInfo = () => localStore.get_data("companyInfo");

export const removeCompanyInfo = () => localStore.remove_data("companyInfo");

export const setCompanyInfo = async (info) => {
  const _data = { ...info };
  await localStore.store_data("companyInfo", _data);
  return true;
};

export const getCompanyInfos = () => localStore.get_data("companyInfos");

export const removeCompanyInfos = () => localStore.remove_data("companyInfos");

export const setCompanyInfos = async (info) => {
  const _data = { ...info };
  await localStore.store_data("companyInfos", _data);
  return true;
};
